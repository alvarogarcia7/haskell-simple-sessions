...
## Problem description
  ...
  * See full problem description at [problem-description](./problem-description.txt), as created by [Alessandro Di Gioia](https://github.com/Parajao), on internal correspondence
